  ...
  return (
    <>
      <style jsx>{`
        ...
        .shiny-cta,
        .shiny-cta-link {
          --shiny-cta-bg-subtle: rgba(255, 255, 255, 0.2);
          --shiny-cta-fg: #ffffff;
          ...
          background:
            linear-gradient(135deg, rgba(255, 255, 255, 0.15), rgba(255, 255, 255, 0.08)) padding-box,
            conic-gradient(
        ...
        @media (prefers-color-scheme: light) {
          .shiny-cta:not(.dark *),
          .shiny-cta-link:not(.dark *) {
            --shiny-cta-bg-subtle: rgba(255, 255, 255, 0.25);
            --shiny-cta-fg: #ffffff;
